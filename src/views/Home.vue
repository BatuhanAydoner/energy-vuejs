...
export default {
  ...
  methods: {
    getFactories() {
      axios
        .post("https://energy-nodejs.vercel.app/api/factory/all", {
    ...
    newFactory() {
      axios
        .post("https://energy-nodejs.vercel.app/api/factory/create-factory", {
          user_id: this.$store.getters.accountDetail.id,
    ...
    updateFactory() {
      axios
        .post("https://energy-nodejs.vercel.app/api/factory/update-factory", {
    ...
    deleteItemConfirm() {
      axios
        .post("https://energy-nodejs.vercel.app/api/factory/delete-factory", {
